...
<template>
  <div class="w-full h-auto flex flex-col gap-4">
    <div class="grid grid-cols-6 gap-4 w-full">
      <poster class="col-span-6 lg:col-span-2" :img="'/images/landingExample1.webp'" />
      <poster class="col-span-3 lg:col-span-2" :img="'/images/model1.webp'" />
      <poster class="col-span-3 lg:col-span-2" :img="'/images/landingExample2.webp'" />
    </div>
    ...
    <div class="flex flex-col w-full items-center lg:w-1/5 mx-auto">
      ...
      <span class="material-symbols-rounded text-[40px] font-bold cursor-pointer">
        <Icon class="mt-3" icon="caretDown" :size="42" />
      </span>
    </div>
